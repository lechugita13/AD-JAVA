...
void MainWindow::crearQActions(){
	...
	accionExamenTab = new QAction("ExamenTab",this);
	connect(accionExamenTab,SIGNAL(triggered()),this,SLOT(slotExamenTab()));
	
	accionExamenDos = new QAction("ExamenDialog",this);
	connect(accionExamenDos,SIGNAL(triggered()),this,SLOT(slotExamenDos()));
}
...
void MainWindow::crearMenus(){
	...
	menuDialogos->addAction(accionGraficos);
		...
		menuExamen->addAction(accionExamenTab);
		menuExamen->addAction(accionExamenDos);
	...
	this->addAction(accionExamenTab);
	this->addAction(accionTabla);
	this->addAction(accionExamenDos);
...
void MainWindow::slotExamenTab(void){

	DTablaPre * dialogo = new DTablaPre(&bolas);
	dialogo->show();	


}

void MainWindow::slotExamenDos(void){

	DExamenDialog * dialogo = new DExamenDialog(&bolas);
	dialogo->show();	
